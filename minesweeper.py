...
class Sentence():
    ...
    def known_mines(self):
        ...
        if len(self.cells) == self.count:
            return self.cells.copy()  # Return all cells as mines
        return set()
    ...
    def known_safes(self):
        ...
        """
        if self.count == 0:
            return self.cells.copy()  # Return all cells as safe
        return set()
    ...
    def mark_mine(self, cell):
        ...
        if cell in self.cells:
            ...
            self.count -= 1  # Reduce the count of mines as we know one mine
    ...
    def mark_safe(self, cell):
        ...
        """
        if cell in self.cells:
            self.cells.remove(cell)  # Just remove the cell, count stays the same
...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
                ...
                if 0 <= i < self.height and 0 <= j < self.width:
                    if (i, j) not in self.safes:
                        if (i, j) in self.mines:
                            count -= 1  # Known mine, so adjust the count
                        else:
                            neighbors.add((i, j))
        ...
        # 5. Infer new sentences from existing sentences
        self.infer_new_sentences()
    
    def update_knowledge(self):
        """
        Goes through the AI's knowledge and marks any additional cells as safe or mines.
        """
        made_changes = True
        while made_changes:
            made_changes = False
    ...
    def infer_new_sentences(self):
        """
        Infers new sentences based on existing knowledge using the subset method.
        If one sentence is a subset of another, infer a new sentence.
        """
        new_sentences = []
        ...
        # After inferring new sentences, update the knowledge again to mark any safes/mines
        self.update_knowledge()
